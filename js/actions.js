$(document).ready(function () {
	...
	*/
	...
	// 				window.location.href = "file:///D:/wordpress/htdocs/online-shopping-system/index.php";
	// 			} else if (data == "cart_login") {
	// 				window.location.href = "file:///D:/wordpress/htdocs/online-shopping-system/cart.php";
	// 			} else {
	// 				$("#e_msg").html(data);
	// 				$(".overlay").hide();
	// 			}
