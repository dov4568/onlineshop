...
if (isset($_POST["email"]) && isset($_POST["password"])) {
	...
	$fetchAllQuery = "SELECT * FROM user_info";
	$data = $con->query($fetchAllQuery);
	$existEmail = false;
	...
	$rowData = mysqli_fetch_array($run_query);

	if (isset($rowData["user_id"]) && isset($rowData["first_name"])) {
		$_SESSION["uid"] = $rowData["user_id"];
		$_SESSION["name"] = $rowData["first_name"];
	}
